...
bool _parseAdvertisedData(NimBLEAdvertisedDevice* advertisedDevice,double &temperature,int &battery);
...
bool BleRaptThermometerLisener::onDeviceFound(NimBLEAdvertisedDevice* device){
...
const NimBLEUUID UuidRaptThermometer(UuidRaptThermometerRaw,16,true);
