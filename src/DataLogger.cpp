...
<tr><td class="logid"></td><td class="logdate"></td><td><button class="dlbutton">Download</button><button class="rmbutton">Delete</button></td></tr>
</table>
</fieldset>
<div id="formatlist">
<table>
