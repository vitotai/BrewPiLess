...
With "DISPLAY_ISPINDEL" option, the addiontal display(screen) would be dedicated to iSpindel Information. This option is only available when SSD1306 OLED type LCD is used.

![iSpindel dedicated display](image/oled-ispindel.jpg)
